...
def run():
    ...
    test_data_provider = LabelledSequenceMinibatchProvider(
        X=X_test,
        Y=Y_test,
    ...
    regularizer = L2Regularizer(lamb=1.2e-4)
    ...
    for batch_index, iteration_info in enumerate(optimizer):
        ...
        if batch_index % 50 == 0:
            X_valid, Y_valid, meta_valid = test_data_provider.next_batch()
